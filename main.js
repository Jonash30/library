...
const updateTotalBooks = () => {
  library.totalBooks = library.myLibrary.length;
  document.getElementById('totalBooks').textContent = library.totalBooks;
}

const updateReadBooks = () => {
  library.readBooks = library.myLibrary.filter((book) => book.read === 'yes').length;
  document.getElementById('booksRead').textContent = library.readBooks;
}
